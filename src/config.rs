...
impl Config {
    ...
    pub fn analytics_config(&self) -> AnalyticsConfig {
        ...
        AnalyticsConfig {
            ...
            heatmap_price_aggregation: default.heatmap_price_aggregation,
            heatmap_time_intervals: default.heatmap_time_intervals.clone(),
            max_heatmap_price_levels: default.max_heatmap_price_levels,
